...
dense_25k_idx = np.load(os.path.join(args.pref_dataset_root, 'train_25k_idx.npy'))
...
dataset_fine = PrefSequenceDatasetMW(pref_dataset_dir=args.pref_dataset_dir, normalizer=dataset.normalizer,
                                     horizon=64, query_len=64, mode='rank', label_key=args.label_key, keep_indx=dense_25k_idx)
assert dataset_fine.seg_num == 2500
